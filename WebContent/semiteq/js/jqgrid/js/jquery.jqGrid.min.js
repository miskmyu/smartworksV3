...
ba=c.p.grouping&&c.p.groupingView.groupCollapse===true;K<M;){A=b[K];D=l(A,H+K);D=c.p.idPrefix+D;k=e===0?0:e+1;P=(k+K)%2==1?F:"";var T=w.length;w.push("");x&&w.push(t(0,K,c.p.page,c.p.rowNum));p&&w.push(s(D,x,K,false));q&&w.push(a(c).jqGrid("addSubGridCell",p+x,K+e));if(j.repeatitems){G||(G=E(p+q+x));var N=a.jgrid.getXmlData(A,j.cell,true);a.each(G,function(a){var b=N[this];if(!b)return false;o=b.textContent||b.text;z[c.p.colModel[a+p+q+x].name]=o;w.push(r(D,o,a+p+q+x,K+e,A))})}else for(k=0;k<u.length;k++){o=
a.jgrid.getXmlData(A,u[k]);z[c.p.colModel[k+p+q+x].name]=o;w.push(r(D,o,k+p+q+x,K+e,A))}w[T]=B(D,ba,P,z,A,false);w.push("</tr>");if(c.p.grouping){O=a(c).jqGrid("groupingPrepare",w,O,z,K);w=[]}if(i||c.p.treeGrid===true){z._id_=D;c.p.data.push(z);c.p._index[D]=c.p.data.length-1}if(c.p.gridview===false){a("tbody:first",d).append(w.join(""));a(c).triggerHandler("jqGridAfterInsertRow",[D,z,A]);g&&c.p.afterInsertRow.call(c,D,z,A);w=[]}z={};m++;K++;if(m==I)break}}if(c.p.gridview===true){n=c.p.treeANode>
...
w===c.p.selrow);var T=D.length;D.push("");x&&D.push(t(0,b,c.p.page,c.p.rowNum));p&&D.push(s(w,x,b,O));q&&D.push(a(c).jqGrid("addSubGridCell",p+x,b+e));if(h.repeatitems){h.cell&&(g=a.jgrid.getAccessor(g,h.cell));o||(o=E(p+q+x))}for(n=0;n<o.length;n++){k=a.jgrid.getAccessor(g,o[n]);D.push(r(w,k,n+p+q+x,b+e,g));G[c.p.colModel[n+p+q+x].name]=k}D[T]=B(w,ba,K,G,g,O);D.push("</tr>");if(c.p.grouping){H=a(c).jqGrid("groupingPrepare",D,H,G,b);D=[]}if(j||c.p.treeGrid===true){G._id_=w;c.p.data.push(G);c.p._index[w]=
...
h).width(f)}c.p._nvtd=[];c.p._nvtd[0]=f?Math.floor((c.p.width-f)/2):Math.floor(c.p.width/3);c.p._nvtd[1]=0;f=null;a(".ui-pg-selbox","#"+h).bind("change",function(){c.p.page=Math.round(c.p.rowNum*(c.p.page-1)/this.value-0.5)+1;c.p.rowNum=this.value;c.p.pager&&a(".ui-pg-selbox",c.p.pager).val(this.value);c.p.toppager&&a(".ui-pg-selbox",c.p.toppager).val(this.value);if(!n("records"))return false;Q();return false});if(c.p.pgbuttons===true){a(".ui-pg-button","#"+h).hover(function(){if(a(this).hasClass("ui-state-disabled"))this.style.cursor=
...
1&&a===0){i=h=false;a=b-1}if(this.id==="first"+d&&f){c.p.page=1;e=true}if(this.id==="prev"+d&&g){c.p.page=a-1;e=true}if(this.id==="next"+d&&h){c.p.page=a+1;e=true}if(this.id==="last"+d&&i){c.p.page=b;e=true}if(e){if(!n(this.id))return false;Q()}return false})}c.p.pginput===true&&a("input.ui-pg-input","#"+h).keypress(function(b){if((b.charCode?b.charCode:b.keyCode?b.keyCode:0)==13){c.p.page=a(this).val()>0?a(this).val():c.p.page;if(!n("user"))return false;Q();return false}return this})};var X=function(b,
...
false&&!isNaN(c.p.height)?i:0);e.width=c.p.width;c.p.tblwidth=b;if(c.p.shrinkToFit===false&&c.p.forceFit===true)c.p.forceFit=false;if(c.p.shrinkToFit===true&&f>0){k=e.width-d*f-n;if(!isNaN(c.p.height)){k=k-i;l=true}b=0;a.each(c.p.colModel,function(a){if(this.hidden===false&&!this.fixed){this.width=j=Math.round(k*this.width/(c.p.tblwidth-d*f-n));b=b+j;g=a}});p=0;l?e.width-n-(b+d*f)!==i&&(p=e.width-n-(b+d*f)-i):!l&&Math.abs(e.width-n-(b+d*f))!==1&&(p=e.width-n-(b+d*f));c.p.colModel[g].width=c.p.colModel[g].width+
p;c.p.tblwidth=b+p+d*f+n;if(c.p.tblwidth>c.p.width){c.p.colModel[g].width=c.p.colModel[g].width-(c.p.tblwidth-parseInt(c.p.width,10));c.p.tblwidth=c.p.width}}})();a(n).css("width",e.width+"px").append("<div class='ui-jqgrid-resize-mark' id='rs_m"+c.p.id+"'>&#160;</div>");a(j).css("width",e.width+"px");var L=a("thead:first",c).get(0),P="";c.p.footerrow&&(P+="<table role='grid' style='width:"+c.p.tblwidth+"px' class='ui-jqgrid-ftable' cellspacing='0' cellpadding='0' border='0'><tbody><tr role='row' class='ui-widget-content footrow footrow-"+
i+"'>");var j=a("tr:first",L),$="<tr class='jqgfirstrow' role='row' style='height:auto'>";c.p.disableClick=!1;a("th",j).each(function(b){C=c.p.colModel[b].width;if(typeof c.p.colModel[b].resizable==="undefined")c.p.colModel[b].resizable=true;if(c.p.colModel[b].resizable){G=document.createElement("span");a(G).html("&#160;").addClass("ui-jqgrid-resize ui-jqgrid-resize-"+i);a.browser.opera||a(G).css("cursor","col-resize");a(this).addClass(c.p.resizeclass)}else G="";a(this).css("width",C+"px").prepend(G);
var d="";if(c.p.colModel[b].hidden){a(this).css("display","none");d="display:none;"}$=$+("<td role='gridcell' style='height:0px;width:"+C+"px;"+d+"'></td>");e.headers[b]={width:C,el:this};M=c.p.colModel[b].sortable;if(typeof M!=="boolean")M=c.p.colModel[b].sortable=true;d=c.p.colModel[b].name;d=="cb"||(d=="subgrid"||d=="rn")||c.p.viewsortcols[2]&&a(">div",this).addClass("ui-jqgrid-sortable");if(M)if(c.p.viewsortcols[0]){a("div span.s-ico",this).show();b==c.p.lastsort&&a("div span.ui-icon-"+c.p.sortorder,
this).removeClass("ui-state-disabled")}else if(b==c.p.lastsort){a("div span.s-ico",this).show();a("div span.ui-icon-"+c.p.sortorder,this).removeClass("ui-state-disabled")}c.p.footerrow&&(P=P+("<td role='gridcell' "+l(b,0,"",null,"",false)+">&#160;</td>"))}).mousedown(function(b){if(a(b.target).closest("th>span.ui-jqgrid-resize").length==1){var d=V(this);if(c.p.forceFit===true){var f=c.p,g=d,i;for(i=d+1;i<c.p.colModel.length;i++)if(c.p.colModel[i].hidden!==true){g=i;break}f.nv=g-d}e.dragStart(d,b,
Y(d));return false}}).click(function(b){if(c.p.disableClick)return c.p.disableClick=false;var d="th>div.ui-jqgrid-sortable",e,f;c.p.viewsortcols[2]||(d="th>div>span>span.ui-grid-ico-sort");b=a(b.target).closest(d);if(b.length==1){d=V(this);if(!c.p.viewsortcols[2]){e=true;f=b.attr("sort")}X(a("div",this)[0].id,d,e,f);return false}});if(c.p.sortable&&a.fn.sortable)try{a(c).jqGrid("sortableColumns",j)}catch(ba){}c.p.footerrow&&(P+="</tr></tbody></table>");$+="</tr>";this.appendChild(document.createElement("tbody"));
a(this).addClass("ui-jqgrid-btable").append($);var $=null,j=a("<table class='ui-jqgrid-htable' style='width:"+c.p.tblwidth+"px' role='grid' aria-labelledby='gbox_"+this.id+"' cellspacing='0' cellpadding='0' border='0'></table>").append(L),R=c.p.caption&&!0===c.p.hiddengrid?!0:!1;g=a("<div class='ui-jqgrid-hbox"+("rtl"==i?"-rtl":"")+"'></div>");L=null;e.hDiv=document.createElement("div");a(e.hDiv).css({width:e.width+"px"}).addClass("ui-state-default ui-jqgrid-hdiv").append(g);a(g).append(j);j=null;
R&&a(e.hDiv).hide();c.p.pager&&("string"==typeof c.p.pager?"#"!=c.p.pager.substr(0,1)&&(c.p.pager="#"+c.p.pager):c.p.pager="#"+a(c.p.pager).attr("id"),a(c.p.pager).css({width:e.width+"px"}).appendTo(n).addClass("ui-state-default ui-jqgrid-pager ui-corner-bottom"),R&&a(c.p.pager).hide(),k(c.p.pager,""));!1===c.p.cellEdit&&!0===c.p.hoverrows&&a(c).bind("mouseover",function(b){w=a(b.target).closest("tr.jqgrow");a(w).attr("class")!=="ui-subgrid"&&a(w).addClass("ui-state-hover")}).bind("mouseout",function(b){w=
a(b.target).closest("tr.jqgrow");a(w).removeClass("ui-state-hover")});var I,U,ca;a(c).before(e.hDiv).click(function(b){z=b.target;w=a(z,c.rows).closest("tr.jqgrow");if(a(w).length===0||w[0].className.indexOf("ui-state-disabled")>-1||(a(z,c).closest("table.ui-jqgrid-btable").attr("id")||"").replace("_frozen","")!==c.id)return this;var d=a(z).hasClass("cbox"),e=a(c).triggerHandler("jqGridBeforeSelectRow",[w[0].id,b]);(e=e===false||e==="stop"?false:true)&&a.isFunction(c.p.beforeSelectRow)&&(e=c.p.beforeSelectRow.call(c,
w[0].id,b));if(!(z.tagName=="A"||(z.tagName=="INPUT"||z.tagName=="TEXTAREA"||z.tagName=="OPTION"||z.tagName=="SELECT")&&!d)&&e===true){I=w[0].id;U=a.jgrid.getCellIndex(z);ca=a(z).closest("td,th").html();a(c).triggerHandler("jqGridCellSelect",[I,U,ca,b]);a.isFunction(c.p.onCellSelect)&&c.p.onCellSelect.call(c,I,U,ca,b);if(c.p.cellEdit===true)if(c.p.multiselect&&d)a(c).jqGrid("setSelection",I,true,b);else{I=w[0].rowIndex;try{a(c).jqGrid("editCell",I,U,true)}catch(f){}}else if(c.p.multikey)if(b[c.p.multikey])a(c).jqGrid("setSelection",
I,true,b);else{if(c.p.multiselect&&d){d=a("#jqg_"+a.jgrid.jqID(c.p.id)+"_"+I).is(":checked");a("#jqg_"+a.jgrid.jqID(c.p.id)+"_"+I)[c.p.useProp?"prop":"attr"]("checked",d)}}else{if(c.p.multiselect&&c.p.multiboxonly&&!d){var g=c.p.frozenColumns?c.p.id+"_frozen":"";a(c.p.selarrrow).each(function(b,d){var e=c.rows.namedItem(d);a(e).removeClass("ui-state-highlight");a("#jqg_"+a.jgrid.jqID(c.p.id)+"_"+a.jgrid.jqID(d))[c.p.useProp?"prop":"attr"]("checked",false);if(g){a("#"+a.jgrid.jqID(d),"#"+a.jgrid.jqID(g)).removeClass("ui-state-highlight");
a("#jqg_"+a.jgrid.jqID(c.p.id)+"_"+a.jgrid.jqID(d),"#"+a.jgrid.jqID(g))[c.p.useProp?"prop":"attr"]("checked",false)}});c.p.selarrrow=[]}a(c).jqGrid("setSelection",I,true,b)}}}).bind("reloadGrid",function(b,d){if(c.p.treeGrid===true)c.p.datatype=c.p.treedatatype;d&&d.current&&c.grid.selectionPreserver(c);if(c.p.datatype=="local"){a(c).jqGrid("resetSelection");c.p.data.length&&x()}else if(!c.p.treeGrid){c.p.selrow=null;if(c.p.multiselect){c.p.selarrrow=[];J(false)}c.p.savedRow=[]}c.p.scroll&&y.call(c,
true,false);if(d&&d.page){var e=d.page;if(e>c.p.lastpage)e=c.p.lastpage;e<1&&(e=1);c.p.page=e;c.grid.bDiv.scrollTop=c.grid.prevRowHeight?(e-1)*c.grid.prevRowHeight*c.p.rowNum:0}if(c.grid.prevRowHeight&&c.p.scroll){delete c.p.lastpage;c.grid.populateVisible()}else c.grid.populate();c.p._inlinenav===true&&a(c).jqGrid("showAddEditButtons");return false}).dblclick(function(b){z=b.target;w=a(z,c.rows).closest("tr.jqgrow");if(a(w).length!==0){I=w[0].rowIndex;U=a.jgrid.getCellIndex(z);a(c).triggerHandler("jqGridDblClickRow",
[a(w).attr("id"),I,U,b]);a.isFunction(this.p.ondblClickRow)&&c.p.ondblClickRow.call(c,a(w).attr("id"),I,U,b)}}).bind("contextmenu",function(b){z=b.target;w=a(z,c.rows).closest("tr.jqgrow");if(a(w).length!==0){c.p.multiselect||a(c).jqGrid("setSelection",w[0].id,true,b);I=w[0].rowIndex;U=a.jgrid.getCellIndex(z);a(c).triggerHandler("jqGridRightClickRow",[a(w).attr("id"),I,U,b]);a.isFunction(this.p.onRightClickRow)&&c.p.onRightClickRow.call(c,a(w).attr("id"),I,U,b)}});e.bDiv=document.createElement("div");
m&&"auto"===(""+c.p.height).toLowerCase()&&(c.p.height="100%");a(e.bDiv).append(a('<div style="position:relative;'+(m&&8>a.browser.version?"height:0.01%;":"")+'"></div>').append("<div></div>").append(this)).addClass("ui-jqgrid-bdiv").css({height:c.p.height+(isNaN(c.p.height)?"":"px"),width:e.width+"px"}).scroll(e.scrollGrid);a("table:first",e.bDiv).css({width:c.p.tblwidth+"px"});m?(2==a("tbody",this).length&&a("tbody:gt(0)",this).remove(),c.p.multikey&&a(e.bDiv).bind("selectstart",function(){return false})):
...
a(c).jqGrid("gridDnD","updateDnD");a(c).triggerHandler("jqGridGridComplete");a.isFunction(c.p.gridComplete)&&c.p.gridComplete.call(c);a(c).triggerHandler("jqGridAfterGridComplete")};c.refreshIndex=x;c.setHeadCheckBox=J;c.constructTr=B;c.formatter=function(a,b,c,d,e){return p(a,b,c,d,e)};a.extend(e,{populate:Q,emptyRows:y});this.grid=e;c.addXmlData=function(a){A(a,c.grid.bDiv)};c.addJSONData=function(a){F(a,c.grid.bDiv)};this.grid.cols=this.rows[0].cells;Q();c.p.hiddengrid=!1}}}})};a.jgrid.extend({getGridParam:function(a){var e=
this[0];if(e&&e.grid)return a?"undefined"!=typeof e.p[a]?e.p[a]:null:e.p},setGridParam:function(d){return this.each(function(){this.grid&&"object"===typeof d&&a.extend(!0,this.p,d)})},getDataIDs:function(){var d=[],e=0,b,f=0;this.each(function(){if((b=this.rows.length)&&0<b)for(;e<b;)a(this.rows[e]).hasClass("jqgrow")&&(d[f]=this.rows[e].id,f++),e++});return d},setSelection:function(d,e,b){return this.each(function(){var f,c,h,g,i,j;if(void 0!==d&&(e=!1===e?!1:!0,(c=this.rows.namedItem(d+""))&&c.className&&
!(-1<c.className.indexOf("ui-state-disabled"))))(!0===this.p.scrollrows&&(h=this.rows.namedItem(d).rowIndex,0<=h&&(f=a(this.grid.bDiv)[0].clientHeight,g=a(this.grid.bDiv)[0].scrollTop,i=a(this.rows[h]).position().top,h=this.rows[h].clientHeight,i+h>=f+g?a(this.grid.bDiv)[0].scrollTop=i-(f+g)+h+g:i<f+g&&i<g&&(a(this.grid.bDiv)[0].scrollTop=i))),!0===this.p.frozenColumns&&(j=this.p.id+"_frozen"),this.p.multiselect)?(this.setHeadCheckBox(!1),this.p.selrow=c.id,g=a.inArray(this.p.selrow,this.p.selarrrow),
-1===g?("ui-subgrid"!==c.className&&a(c).addClass("ui-state-highlight").attr("aria-selected","true"),f=!0,this.p.selarrrow.push(this.p.selrow)):("ui-subgrid"!==c.className&&a(c).removeClass("ui-state-highlight").attr("aria-selected","false"),f=!1,this.p.selarrrow.splice(g,1),i=this.p.selarrrow[0],this.p.selrow=void 0===i?null:i),a("#jqg_"+a.jgrid.jqID(this.p.id)+"_"+a.jgrid.jqID(c.id))[this.p.useProp?"prop":"attr"]("checked",f),j&&(-1===g?a("#"+a.jgrid.jqID(d),"#"+a.jgrid.jqID(j)).addClass("ui-state-highlight"):
a("#"+a.jgrid.jqID(d),"#"+a.jgrid.jqID(j)).removeClass("ui-state-highlight"),a("#jqg_"+a.jgrid.jqID(this.p.id)+"_"+a.jgrid.jqID(d),"#"+a.jgrid.jqID(j))[this.p.useProp?"prop":"attr"]("checked",f)),a(this).triggerHandler("jqGridSelectRow",[c.id,f,b]),this.p.onSelectRow&&e&&this.p.onSelectRow.call(this,c.id,f,b)):"ui-subgrid"!==c.className&&(this.p.selrow!=c.id?(a(this.rows.namedItem(this.p.selrow)).removeClass("ui-state-highlight").attr({"aria-selected":"false",tabindex:"-1"}),a(c).addClass("ui-state-highlight").attr({"aria-selected":"true",
tabindex:"0"}),j&&(a("#"+a.jgrid.jqID(this.p.selrow),"#"+a.jgrid.jqID(j)).removeClass("ui-state-highlight"),a("#"+a.jgrid.jqID(d),"#"+a.jgrid.jqID(j)).addClass("ui-state-highlight")),f=!0):f=!1,this.p.selrow=c.id,a(this).triggerHandler("jqGridSelectRow",[c.id,f,b]),this.p.onSelectRow&&e&&this.p.onSelectRow.call(this,c.id,f,b))})},resetSelection:function(d){return this.each(function(){var e=this,b,f,c;!0===e.p.frozenColumns&&(c=e.p.id+"_frozen");if("undefined"!==typeof d){f=d===e.p.selrow?e.p.selrow:
d;a("#"+a.jgrid.jqID(e.p.id)+" tbody:first tr#"+a.jgrid.jqID(f)).removeClass("ui-state-highlight").attr("aria-selected","false");c&&a("#"+a.jgrid.jqID(f),"#"+a.jgrid.jqID(c)).removeClass("ui-state-highlight");if(e.p.multiselect){a("#jqg_"+a.jgrid.jqID(e.p.id)+"_"+a.jgrid.jqID(f),"#"+a.jgrid.jqID(e.p.id))[e.p.useProp?"prop":"attr"]("checked",!1);if(c)a("#jqg_"+a.jgrid.jqID(e.p.id)+"_"+a.jgrid.jqID(f),"#"+a.jgrid.jqID(c))[e.p.useProp?"prop":"attr"]("checked",!1);e.setHeadCheckBox(!1)}f=null}else e.p.multiselect?
(a(e.p.selarrrow).each(function(d,f){b=e.rows.namedItem(f);a(b).removeClass("ui-state-highlight").attr("aria-selected","false");a("#jqg_"+a.jgrid.jqID(e.p.id)+"_"+a.jgrid.jqID(f))[e.p.useProp?"prop":"attr"]("checked",!1);c&&(a("#"+a.jgrid.jqID(f),"#"+a.jgrid.jqID(c)).removeClass("ui-state-highlight"),a("#jqg_"+a.jgrid.jqID(e.p.id)+"_"+a.jgrid.jqID(f),"#"+a.jgrid.jqID(c))[e.p.useProp?"prop":"attr"]("checked",!1))}),e.setHeadCheckBox(!1),e.p.selarrrow=[]):e.p.selrow&&(a("#"+a.jgrid.jqID(e.p.id)+" tbody:first tr#"+
a.jgrid.jqID(e.p.selrow)).removeClass("ui-state-highlight").attr("aria-selected","false"),c&&a("#"+a.jgrid.jqID(e.p.selrow),"#"+a.jgrid.jqID(c)).removeClass("ui-state-highlight"),e.p.selrow=null);!0===e.p.cellEdit&&(0<=parseInt(e.p.iCol,10)&&0<=parseInt(e.p.iRow,10))&&(a("td:eq("+e.p.iCol+")",e.rows[e.p.iRow]).removeClass("edit-cell ui-state-highlight"),a(e.rows[e.p.iRow]).removeClass("selected-row ui-state-hover"));e.p.savedRow=[]})},getRowData:function(d){var e={},b,f=!1,c,h=0;this.each(function(){var g=
this,i,j;if("undefined"==typeof d)f=!0,b=[],c=g.rows.length;else{j=g.rows.namedItem(d);if(!j)return e;c=2}for(;h<c;)f&&(j=g.rows[h]),a(j).hasClass("jqgrow")&&(a('td[role="gridcell"]',j).each(function(b){i=g.p.colModel[b].name;if("cb"!==i&&"subgrid"!==i&&"rn"!==i)if(!0===g.p.treeGrid&&i==g.p.ExpandColumn)e[i]=a.jgrid.htmlDecode(a("span:first",this).html());else try{e[i]=a.unformat.call(g,this,{rowId:j.id,colModel:g.p.colModel[b]},b)}catch(c){e[i]=a.jgrid.htmlDecode(a(this).html())}}),f&&(b.push(e),
e={})),h++});return b?b:e},delRowData:function(d){var e=!1,b,f;this.each(function(){if(b=this.rows.namedItem(d)){if(a(b).remove(),this.p.records--,this.p.reccount--,this.updatepager(!0,!1),e=!0,this.p.multiselect&&(f=a.inArray(d,this.p.selarrrow),-1!=f&&this.p.selarrrow.splice(f,1)),d==this.p.selrow)this.p.selrow=null}else return!1;if("local"==this.p.datatype){var c=this.p._index[a.jgrid.stripPref(this.p.idPrefix,d)];"undefined"!=typeof c&&(this.p.data.splice(c,1),this.refreshIndex())}if(!0===this.p.altRows&&
e){var h=this.p.altclass;a(this.rows).each(function(b){1==b%2?a(this).addClass(h):a(this).removeClass(h)})}});return e},setRowData:function(d,e,b){var f,c=!0,h;this.each(function(){if(!this.grid)return!1;var g=this,i,j,k=typeof b,m={};j=g.rows.namedItem(d);if(!j)return!1;if(e)try{if(a(this.p.colModel).each(function(b){f=this.name;void 0!==e[f]&&(m[f]=this.formatter&&"string"===typeof this.formatter&&"date"==this.formatter?a.unformat.date.call(g,e[f],this):e[f],i=g.formatter(d,e[f],b,e,"edit"),h=this.title?
{title:a.jgrid.stripHtml(i)}:{},!0===g.p.treeGrid&&f==g.p.ExpandColumn?a("td:eq("+b+") > span:first",j).html(i).attr(h):a("td:eq("+b+")",j).html(i).attr(h))}),"local"==g.p.datatype){var n=a.jgrid.stripPref(g.p.idPrefix,d),o=g.p._index[n];if(g.p.treeGrid)for(var l in g.p.treeReader)m.hasOwnProperty(g.p.treeReader[l])&&delete m[g.p.treeReader[l]];"undefined"!=typeof o&&(g.p.data[o]=a.extend(!0,g.p.data[o],m));m=null}}catch(q){c=!1}c&&("string"===k?a(j).addClass(b):"object"===k&&a(j).css(b),a(g).triggerHandler("jqGridAfterGridComplete"))});
return c},addRowData:function(d,e,b,f){b||(b="last");var c=!1,h,g,i,j,k,m,n,o,l="",q,p,r,s,t,v;e&&(a.isArray(e)?(q=!0,b="last",p=d):(e=[e],q=!1),this.each(function(){var E=e.length;k=this.p.rownumbers===true?1:0;i=this.p.multiselect===true?1:0;j=this.p.subGrid===true?1:0;if(!q)if(typeof d!="undefined")d=d+"";else{d=a.jgrid.randId();if(this.p.keyIndex!==false){p=this.p.colModel[this.p.keyIndex+i+j+k].name;typeof e[0][p]!="undefined"&&(d=e[0][p])}}r=this.p.altclass;for(var y=0,x="",B={},A=a.isFunction(this.p.afterInsertRow)?
true:false;y<E;){s=e[y];g=[];if(q){try{d=s[p]}catch(F){d=a.jgrid.randId()}x=this.p.altRows===true?(this.rows.length-1)%2===0?r:"":""}v=d;d=this.p.idPrefix+d;if(k){l=this.formatCol(0,1,"",null,d,true);g[g.length]='<td role="gridcell" class="ui-state-default jqgrid-rownum" '+l+">0</td>"}if(i){o='<input role="checkbox" type="checkbox" id="jqg_'+this.p.id+"_"+d+'" class="cbox"/>';l=this.formatCol(k,1,"",null,d,true);g[g.length]='<td role="gridcell" '+l+">"+o+"</td>"}j&&(g[g.length]=a(this).jqGrid("addSubGridCell",
i+k,1));for(n=i+j+k;n<this.p.colModel.length;n++){t=this.p.colModel[n];h=t.name;B[h]=s[h];o=this.formatter(d,a.jgrid.getAccessor(s,h),n,s);l=this.formatCol(n,1,o,s,d,true);g[g.length]='<td role="gridcell" '+l+">"+o+"</td>"}g.unshift(this.constructTr(d,false,x,B,s,false));g[g.length]="</tr>";if(this.rows.length===0)a("table:first",this.grid.bDiv).append(g.join(""));else switch(b){case "last":a(this.rows[this.rows.length-1]).after(g.join(""));m=this.rows.length-1;break;case "first":a(this.rows[0]).after(g.join(""));
m=1;break;case "after":(m=this.rows.namedItem(f))&&(a(this.rows[m.rowIndex+1]).hasClass("ui-subgrid")?a(this.rows[m.rowIndex+1]).after(g):a(m).after(g.join("")));m++;break;case "before":if(m=this.rows.namedItem(f)){a(m).before(g.join(""));m=m.rowIndex}m--}this.p.subGrid===true&&a(this).jqGrid("addSubGrid",i+k,m);this.p.records++;this.p.reccount++;a(this).triggerHandler("jqGridAfterInsertRow",[d,s,s]);A&&this.p.afterInsertRow.call(this,d,s,s);y++;if(this.p.datatype=="local"){B[this.p.localReader.id]=
v;this.p._index[v]=this.p.data.length;this.p.data.push(B);B={}}}this.p.altRows===true&&!q&&(b=="last"?(this.rows.length-1)%2==1&&a(this.rows[this.rows.length-1]).addClass(r):a(this.rows).each(function(b){b%2==1?a(this).addClass(r):a(this).removeClass(r)}));this.updatepager(true,true);c=true}));return c},footerData:function(d,e,b){function f(a){for(var b in a)if(a.hasOwnProperty(b))return!1;return!0}var c,h=!1,g={},i;"undefined"==typeof d&&(d="get");"boolean"!=typeof b&&(b=!0);d=d.toLowerCase();this.each(function(){var j=
this,k;if(!j.grid||!j.p.footerrow||"set"==d&&f(e))return!1;h=!0;a(this.p.colModel).each(function(f){c=this.name;"set"==d?void 0!==e[c]&&(k=b?j.formatter("",e[c],f,e,"edit"):e[c],i=this.title?{title:a.jgrid.stripHtml(k)}:{},a("tr.footrow td:eq("+f+")",j.grid.sDiv).html(k).attr(i),h=!0):"get"==d&&(g[c]=a("tr.footrow td:eq("+f+")",j.grid.sDiv).html())})});return"get"==d?g:h},showHideCol:function(d,e){return this.each(function(){var b=this,f=!1,c=a.jgrid.cellWidth()?0:b.p.cellLayout,h;if(b.grid){"string"===
...
d+"px"));b.p.footerrow&&a(b.grid.sDiv).css("width",d+"px");!1===e&&!0===b.p.forceFit&&(b.p.forceFit=!1);if(!0===e){a.each(b.p.colModel,function(){if(this.hidden===false){f=this.widthOrg;c=c+(f+h);this.fixed?n=n+(f+h):i++;o++}});if(0===i)return;b.p.tblwidth=c;m=d-h*i-n;if(!isNaN(b.p.height)&&(a(b.grid.bDiv)[0].clientHeight<a(b.grid.bDiv)[0].scrollHeight||1===b.rows.length))j=!0,m-=k;var c=0,q=0<b.grid.cols.length;a.each(b.p.colModel,function(a){if(this.hidden===false&&!this.fixed){f=this.widthOrg;
f=Math.round(m*f/(b.p.tblwidth-h*i-n));if(!(f<0)){this.width=f;c=c+f;b.grid.headers[a].width=f;b.grid.headers[a].el.style.width=f+"px";if(b.p.footerrow)b.grid.footers[a].style.width=f+"px";if(q)b.grid.cols[a].style.width=f+"px";g=a}}});if(!g)return;l=0;j?d-n-(c+h*i)!==k&&(l=d-n-(c+h*i)-k):1!==Math.abs(d-n-(c+h*i))&&(l=d-n-(c+h*i));b.p.colModel[g].width+=l;b.p.tblwidth=c+l+h*i+n;b.p.tblwidth>d?(j=b.p.tblwidth-parseInt(d,10),b.p.tblwidth=d,f=b.p.colModel[g].width-=j):f=b.p.colModel[g].width;b.grid.headers[g].width=
...
{role:"gridcell"}).css(h).addClass("ui-first-th-"+this.p.direction).appendTo(q),g.style.width="",h=r(b.name,d.groupHeaders),0<=h){h=d.groupHeaders[h];f=h.numberOfColumns;j=h.titleText;for(h=b=0;h<f&&e+h<m;h++)k[e+h].hidden||b++;h=a("<th>").attr({role:"columnheader"}).addClass("ui-state-default ui-th-column-header ui-th-"+this.p.direction).css({height:"22px","border-top":"0px none"}).html(j);0<b&&h.attr("colspan",""+b);this.p.headertitles&&h.attr("title",h.text());0===b&&h.hide();i.before(h);c.append(g);
...
c=a(d).text().replace(e,"");break;case "number":g=a.extend({},c.number,g);e=g.thousandsSeparator.replace(i,"\\$1");e=RegExp(e,"g");c=a(d).text().replace(e,"").replace(g.decimalSeparator,".");break;case "currency":g=a.extend({},c.currency,g);e=g.thousandsSeparator.replace(i,"\\$1");e=RegExp(e,"g");c=a(d).text();g.prefix&&g.prefix.length&&(c=c.substr(g.prefix.length));g.suffix&&g.suffix.length&&(c=c.substr(0,c.length-g.suffix.length));c=c.replace(e,"").replace(g.decimalSeparator,".");break;case "checkbox":g=
e.colModel.editoptions?e.colModel.editoptions.value.split(":"):["Yes","No"];c=a("input",d).is(":checked")?g[0]:g[1];break;case "select":c=a.unformat.select(d,e,b,f);break;case "actions":return"";default:c=a(d).text()}return void 0!==c?c:!0===f?a(d).text():a.jgrid.htmlDecode(a(d).html())};a.unformat.select=function(d,e,b,f){b=[];d=a(d).text();if(!0===f)return d;var f=a.extend({},!a.fmatter.isUndefined(e.colModel.formatoptions)?e.colModel.formatoptions:e.colModel.editoptions),e=void 0===f.separator?
":":f.separator,c=void 0===f.delimiter?";":f.delimiter;if(f.value){var h=f.value,f=!0===f.multiple?!0:!1,g=[];f&&(g=d.split(","),g=a.map(g,function(b){return a.trim(b)}));if(a.fmatter.isString(h))for(var i=h.split(c),j=0,k=0;k<i.length;k++)if(c=i[k].split(e),2<c.length&&(c[1]=a.map(c,function(a,b){if(b>0)return a}).join(e)),f)-1<a.inArray(c[1],g)&&(b[j]=c[0],j++);else{if(a.trim(c[1])==a.trim(d)){b[0]=c[0];break}}else if(a.fmatter.isObject(h)||a.isArray(h))f||(g[0]=d),b=a.map(g,function(b){var c;a.each(h,
function(a,d){if(d==b){c=a;return false}});if(typeof c!="undefined")return c});return b.join(", ")}return d||""};a.unformat.date=function(d,e){var b=a.jgrid.formatter.date||{};a.fmatter.isUndefined(e.formatoptions)||(b=a.extend({},b,e.formatoptions));return!a.fmatter.isEmpty(d)?a.fmatter.util.DateFormat(b.newformat,d,b.srcformat,b):a.fn.fmatter.defaultFormat(d,e)}})(jQuery);
...
b)),h.append(i);void 0===b.groupOp&&(b.groupOp=d.p.groupOps[0].op);if(void 0!==b.rules)for(e=0;e<b.rules.length;e++)g.append(this.createTableRowForRule(b.rules[e],b));return g};this.createTableRowForRule=function(b,c){var d=this,e=a("<tr></tr>"),g,h,j,r,s="",t;e.append("<td class='first'></td>");var v=a("<td class='columns'></td>");e.append(v);var E=a("<select></select>"),y,x=[];v.append(E);E.bind("change",function(){b.field=a(E).val();j=a(this).parents("tr:first");for(g=0;g<d.p.columns.length;g++)if(d.p.columns[g].name===
b.field){r=d.p.columns[g];break}if(r){r.searchoptions.id=a.jgrid.randId();i&&"text"===r.inputtype&&!r.searchoptions.size&&(r.searchoptions.size=10);var c=a.jgrid.createEl(r.inputtype,r.searchoptions,"",!0,d.p.ajaxSelectOptions,!0);a(c).addClass("input-elm");h=r.searchoptions.sopt?r.searchoptions.sopt:d.p.sopt?d.p.sopt:"string"===r.searchtype?d.p.stropts:d.p.numopts;var e="",f=0;x=[];a.each(d.p.ops,function(){x.push(this.name)});for(g=0;g<h.length;g++)y=a.inArray(h[g],x),-1!==y&&(0===f&&(b.op=d.p.ops[y].name),
...
"SPAN"&&r.searchoptions&&a.isFunction(r.searchoptions.custom_value)?r.searchoptions.custom_value(a(e).children(".customelement:first"),"get"):e.value;d.onchange()},e)});setTimeout(function(){b.data=a(c).val();d.onchange()},0)}});for(g=v=0;g<d.p.columns.length;g++){t="undefined"===typeof d.p.columns[g].search?!0:d.p.columns[g].search;var B=!0===d.p.columns[g].hidden;if(!0===d.p.columns[g].searchoptions.searchhidden&&t||t&&!B)t="",b.field===d.p.columns[g].name&&(t=" selected='selected'",v=g),s+="<option value='"+
d.p.columns[g].name+"'"+t+">"+d.p.columns[g].label+"</option>"}E.append(s);s=a("<td class='operators'></td>");e.append(s);r=f.columns[v];r.searchoptions.id=a.jgrid.randId();i&&"text"===r.inputtype&&!r.searchoptions.size&&(r.searchoptions.size=10);var v=a.jgrid.createEl(r.inputtype,r.searchoptions,b.data,!0,d.p.ajaxSelectOptions,!0),A=a("<select class='selectopts'></select>");s.append(A);A.bind("change",function(){b.op=a(A).val();j=a(this).parents("tr:first");var c=a(".input-elm",j)[0];if(b.op==="nu"||
b.op==="nn"){b.data="";c.value="";c.setAttribute("readonly","true");c.setAttribute("disabled","true")}else{c.removeAttribute("readonly");c.removeAttribute("disabled")}d.onchange()});h=r.searchoptions.sopt?r.searchoptions.sopt:d.p.sopt?d.p.sopt:"string"===r.searchtype?f.stropts:d.p.numopts;s="";a.each(d.p.ops,function(){x.push(this.name)});for(g=0;g<h.length;g++)y=a.inArray(h[g],x),-1!==y&&(t=b.op===d.p.ops[y].name?" selected='selected'":"",s+="<option value='"+d.p.ops[y].name+"'"+t+">"+d.p.ops[y].description+
...
d.Reset+"</a>",q="",p="",r,s=!1,t=-1;d.showQuery&&(q="<a href='javascript:void(0)' id='"+c+"_query' class='fm-button ui-state-default ui-corner-all fm-button-icon-left'><span class='ui-icon ui-icon-comment'></span>Query</a>");d.columns.length?n=d.columns:a.each(n,function(a,b){if(!b.label)b.label=f.p.colNames[a];if(!s){var d=typeof b.search==="undefined"?true:b.search,c=b.hidden===true;if(b.searchoptions&&b.searchoptions.searchhidden===true&&d||d&&!c){s=true;r=b.index||b.name;t=a}}});if(!i&&r||!1===
d.multipleSearch){var v="eq";0<=t&&n[t].searchoptions&&n[t].searchoptions.sopt?v=n[t].searchoptions.sopt[0]:d.sopt&&d.sopt.length&&(v=d.sopt[0]);i={groupOp:"AND",rules:[{field:r,op:v,data:""}]}}s=!1;d.tmplNames&&d.tmplNames.length&&(s=!0,p=d.tmplLabel,p+="<select class='ui-template'>",p+="<option value='default'>Default</option>",a.each(d.tmplNames,function(a,b){p=p+("<option value='"+a+"'>"+b+"</option>")}),p+="</select>");k="<table class='EditTable' style='border:0px none;margin-top:5px' id='"+
...
2*f+"'>"+x.rowcontent+"</td></tr>"),a(e).append(t),t[0].rp=v);0===i.length&&(i=a("<tr "+n+" rowpos='"+v+"'></tr>").addClass("FormData").attr("id","tr_"+g),a(i).append(r),a(e).append(i),i[0].rp=v);a("td:eq("+(u-2)+")",i[0]).html("undefined"===typeof x.label?c.p.colNames[q]:x.label);a("td:eq("+(u-1)+")",i[0]).append(x.elmprefix).append(m).append(x.elmsuffix);p[j]=q;j++}});if(0<j&&(q=a("<tr class='FormData' style='display:none'><td class='CaptionTD'></td><td colspan='"+(2*f-1)+"' class='DataTD'><input class='FormElement' id='id_g' type='text' name='"+
c.p.id+"_id' value='"+b+"'/></td></tr>"),q[0].rp=j+999,a(e).append(q),d[l.p.id].checkOnSubmit||d[l.p.id].checkOnUpdate))d[l.p.id]._savedData[c.p.id+"_id"]=b;return p}function h(b,c,e){var f,g=0,h,i,j,k,n;if(d[l.p.id].checkOnSubmit||d[l.p.id].checkOnUpdate)d[l.p.id]._savedData={},d[l.p.id]._savedData[c.p.id+"_id"]=b;var m=c.p.colModel;if("_empty"==b)a(m).each(function(){f=this.name;j=a.extend({},this.editoptions||{});if((i=a("#"+a.jgrid.jqID(f),"#"+e))&&i.length&&null!==i[0])if(k="",j.defaultValue?
...
d[l.p.id].errorTextFormat.call(l,f):g+" Status: '"+f.statusText+"'. Error code: "+f.status}else{e=a(l).triggerHandler("jqGridAddEditAfterSubmit",[f,u,J]);e===void 0&&(e=[true,"",""]);e[0]&&a.isFunction(d[l.p.id].afterSubmit)&&(e=d[l.p.id].afterSubmit.call(l,f,u))}if(e[0]===false){a("#FormError>td",s).html(e[1]);a("#FormError",s).show()}else{a.each(l.p.colModel,function(){if(H[this.name]&&this.formatter&&this.formatter=="select")try{delete H[this.name]}catch(a){}});u=a.extend(u,H);l.p.autoencode&&
...
(e[0]=!1,e[1]=f[1]||"Error deleting the selected row!"):(o.data.oper==i.addoper&&d[l.p.id].closeAfterAdd&&a.jgrid.hideModal("#"+a.jgrid.jqID(t.themodal),{gb:"#gbox_"+a.jgrid.jqID(q),jqm:b.jqModal,onClose:d[l.p.id].onClose}),o.data.oper==i.editoper&&d[l.p.id].closeAfterEdit&&a.jgrid.hideModal("#"+a.jgrid.jqID(t.themodal),{gb:"#gbox_"+a.jgrid.jqID(q),jqm:b.jqModal,onClose:d[l.p.id].onClose}))):a.ajax(o))}!1===e[0]&&(a("#FormError>td",s).html(e[1]),a("#FormError",s).show())}function j(a,b){var c=!1,
d;for(d in a)if(a[d]!=b[d]){c=!0;break}return c}function k(){var b=!0;a("#FormError",s).hide();if(d[l.p.id].checkOnUpdate&&(u={},H={},f(),N=a.extend({},u,H),Q=j(N,d[l.p.id]._savedData)))a("#"+p).data("disabled",!0),a(".confirm","#"+t.themodal).show(),b=!1;return b}function m(){if("_empty"!==e&&"undefined"!==typeof l.p.savedRow&&0<l.p.savedRow.length&&a.isFunction(a.fn.jqGrid.restoreRow))for(var b=0;b<l.p.savedRow.length;b++)if(l.p.savedRow[b].id==e){a(l).jqGrid("restoreRow",e);break}}function n(b,
...
p+"' class='FormGrid' onSubmit='return false;' style='width:100%;overflow:auto;position:relative;height:"+Y+";'></form>").data("disabled",!1),V=a("<table id='"+r+"' class='EditTable' cellspacing='0' cellpadding='0' border='0'><tbody></tbody></table>"),B=a(l).triggerHandler("jqGridAddEditBeforeInitData",[a("#"+p),J]);"undefined"==typeof B&&(B=!0);B&&y&&(B=y.call(l,a("#"+p)));if(!1===B)return;m();a(l.p.colModel).each(function(){var a=this.formoptions;A=Math.max(A,a?a.colpos||0:0);F=Math.max(F,a?a.rowpos||
0:0)});a(Y).append(V);y=a("<tr id='FormError' style='display:none'><td class='ui-state-error' colspan='"+2*A+"'></td></tr>");y[0].rp=0;a(V).append(y);y=a("<tr style='display:none' class='tinfo'><td class='topinfo' colspan='"+2*A+"'>"+d[l.p.id].topinfo+"</td></tr>");y[0].rp=0;a(V).append(y);var B=(y="rtl"==l.p.direction?!0:!1)?"nData":"pData",W=y?"pData":"nData";c(e,l,V,A);var B="<a href='javascript:void(0)' id='"+B+"' class='fm-button ui-state-default ui-corner-left'><span class='ui-icon ui-icon-triangle-1-w'></span></a>",
...
(y?W+B:B+W)+"</td><td class='EditButton'>"+aa+L+"</td></tr>"+("<tr style='display:none' class='binfo'><td class='bottominfo' colspan='2'>"+d[l.p.id].bottominfo+"</td></tr>"),r=r+"</tbody></table>";if(0<F){var Z=[];a.each(a(V)[0].rows,function(a,b){Z[a]=b});Z.sort(function(a,b){return a.rp>b.rp?1:a.rp<b.rp?-1:0});a.each(Z,function(b,c){a("tbody",V).append(c)})}b.gbox="#gbox_"+a.jgrid.jqID(q);var S=!1;!0===b.closeOnEscape&&(b.closeOnEscape=!1,S=!0);r=a("<span></span>").append(Y).append(r);a.jgrid.createModal(t,
...
a.jgrid.jqID(t.themodal)).hide();a("#"+p).data("disabled",false);a.jgrid.hideModal("#"+a.jgrid.jqID(t.themodal),{gb:"#gbox_"+a.jgrid.jqID(q),jqm:b.jqModal,onClose:d[l.p.id].onClose});return false});a(l).triggerHandler("jqGridAddEditInitializeForm",[a("#"+p),J]);x&&x.call(l,a("#"+p));"_empty"==e||!d[l.p.id].viewPagerButtons?a("#pData,#nData",s+"_2").hide():a("#pData,#nData",s+"_2").show();a(l).triggerHandler("jqGridAddEditBeforeShowForm",[a("#"+p),J]);v&&v.call(l,a("#"+p));a("#"+a.jgrid.jqID(t.themodal)).data("onClose",
...
function(){a(this).removeClass("ui-state-hover")});a("#sData",s+"_2").click(function(){u={};H={};a("#FormError",s).hide();f();if(u[l.p.id+"_id"]=="_empty")i();else if(b.checkOnSubmit===true){N=a.extend({},u,H);if(Q=j(N,d[l.p.id]._savedData)){a("#"+p).data("disabled",true);a(".confirm","#"+a.jgrid.jqID(t.themodal)).show()}else i()}else i();return false});a("#cData",s+"_2").click(function(){if(!k())return false;a.jgrid.hideModal("#"+a.jgrid.jqID(t.themodal),{gb:"#gbox_"+a.jgrid.jqID(q),jqm:b.jqModal,
onClose:d[l.p.id].onClose});return false});a("#nData",s+"_2").click(function(){if(!k())return false;a("#FormError",s).hide();var c=o();c[0]=parseInt(c[0],10);if(c[0]!=-1&&c[1][c[0]+1]){a(l).triggerHandler("jqGridAddEditClickPgButtons",["next",a("#"+p),c[1][c[0]]]);var d=true;if(a.isFunction(b.onclickPgButtons)){d=b.onclickPgButtons.call(l,"next",a("#"+p),c[1][c[0]]);if(d!==void 0&&d===false)return false}if(a("#"+a.jgrid.jqID(c[1][c[0]+1])).hasClass("ui-state-disabled"))return false;h(c[1][c[0]+1],
l,p);a(l).jqGrid("setSelection",c[1][c[0]+1]);a(l).triggerHandler("jqGridAddEditAfterClickPgButtons",["next",a("#"+p),c[1][c[0]]]);a.isFunction(b.afterclickPgButtons)&&b.afterclickPgButtons.call(l,"next",a("#"+p),c[1][c[0]+1]);n(c[0]+1,c[1].length-1)}return false});a("#pData",s+"_2").click(function(){if(!k())return false;a("#FormError",s).hide();var c=o();if(c[0]!=-1&&c[1][c[0]-1]){a(l).triggerHandler("jqGridAddEditClickPgButtons",["prev",a("#"+p),c[1][c[0]]]);var d=true;if(a.isFunction(b.onclickPgButtons)){d=
...
d,e,f){for(var g,h,i,j=0,l,k,n=[],m=!1,p="<td class='CaptionTD form-view-label ui-widget-content' width='"+b.labelswidth+"'>&#160;</td><td class='DataTD form-view-data ui-helper-reset ui-widget-content'>&#160;</td>",o="",r=["integer","number","currency"],q=0,t=0,s,v,y,E=1;E<=f;E++)o+=1==E?p:"<td class='CaptionTD form-view-label ui-widget-content'>&#160;</td><td class='DataTD form-view-data ui-widget-content'>&#160;</td>";a(d.p.colModel).each(function(){h=this.editrules&&!0===this.editrules.edithidden?
!1:!0===this.hidden?!0:!1;!h&&"right"===this.align&&(this.formatter&&-1!==a.inArray(this.formatter,r)?q=Math.max(q,parseInt(this.width,10)):t=Math.max(t,parseInt(this.width,10)))});s=0!==q?q:0!==t?t:0;m=a(d).jqGrid("getInd",c);a(d.p.colModel).each(function(b){g=this.name;v=!1;k=(h=this.editrules&&!0===this.editrules.edithidden?!1:!0===this.hidden?!0:!1)?"style='display:none'":"";y="boolean"!=typeof this.viewable?!0:this.viewable;if("cb"!==g&&"subgrid"!==g&&"rn"!==g&&y){l=!1===m?"":g==d.p.ExpandColumn&&
!0===d.p.treeGrid?a("td:eq("+b+")",d.rows[m]).text():a("td:eq("+b+")",d.rows[m]).html();v="right"===this.align&&0!==s?!0:!1;var c=a.extend({},{rowabove:!1,rowcontent:""},this.formoptions||{}),p=parseInt(c.rowpos,10)||j+1,r=parseInt(2*(parseInt(c.colpos,10)||1),10);if(c.rowabove){var q=a("<tr><td class='contentinfo' colspan='"+2*f+"'>"+c.rowcontent+"</td></tr>");a(e).append(q);q[0].rp=p}i=a(e).find("tr[rowpos="+p+"]");0===i.length&&(i=a("<tr "+k+" rowpos='"+p+"'></tr>").addClass("FormData").attr("id",
"trv_"+g),a(i).append(o),a(e).append(i),i[0].rp=p);a("td:eq("+(r-2)+")",i[0]).html("<b>"+("undefined"===typeof c.label?d.p.colNames[b]:c.label)+"</b>");a("td:eq("+(r-1)+")",i[0]).append("<span>"+l+"</span>").attr("id","v_"+g);v&&a("td:eq("+(r-1)+") span",i[0]).css({"text-align":"right",width:s+"px"});n[j]=b;j++}});0<j&&(c=a("<tr class='FormData' style='display:none'><td class='CaptionTD'></td><td colspan='"+(2*f-1)+"' class='DataTD'><input class='FormElement' id='id_g' type='text' name='id' value='"+
c+"'/></td></tr>"),c[0].rp=j+99,a(e).append(c));return n}function h(b,c){var d,e,f=0,g,h;if(h=a(c).jqGrid("getInd",b,!0))a("td",h).each(function(b){d=c.p.colModel[b].name;e=c.p.colModel[b].editrules&&!0===c.p.colModel[b].editrules.edithidden?!1:!0===c.p.colModel[b].hidden?!0:!1;"cb"!==d&&("subgrid"!==d&&"rn"!==d)&&(g=d==c.p.ExpandColumn&&!0===c.p.treeGrid?a(this).text():a(this).html(),a.extend({},c.p.colModel[b].editoptions||{}),d=a.jgrid.jqID("v_"+d),a("#"+d+" span","#"+n).html(g),e&&a("#"+d,"#"+
n).parents("tr:first").hide(),f++)}),0<f&&a("#id_g","#"+n).val(b)}function g(b,c){0===b?a("#pData","#"+n+"_2").addClass("ui-state-disabled"):a("#pData","#"+n+"_2").removeClass("ui-state-disabled");b==c?a("#nData","#"+n+"_2").addClass("ui-state-disabled"):a("#nData","#"+n+"_2").removeClass("ui-state-disabled")}function i(){var b=a(j).jqGrid("getDataIDs"),c=a("#id_g","#"+n).val();return[a.inArray(c,b),b]}var j=this;if(j.grid&&e){var k=j.p.id,m="ViewGrid_"+a.jgrid.jqID(k),n="ViewTbl_"+a.jgrid.jqID(k),
o="ViewGrid_"+k,l="ViewTbl_"+k,q={themodal:"viewmod"+k,modalhead:"viewhd"+k,modalcontent:"viewcnt"+k,scrollelm:m},p=a.isFunction(d[j.p.id].beforeInitData)?d[j.p.id].beforeInitData:!1,r=!0,s=1,t=0;if(void 0!==a("#"+a.jgrid.jqID(q.themodal))[0]){p&&(r=p.call(j,a("#"+m)),"undefined"==typeof r&&(r=!0));if(!1===r)return;a(".ui-jqdialog-title","#"+a.jgrid.jqID(q.modalhead)).html(b.caption);a("#FormError","#"+n).hide();h(e,j);a.isFunction(d[j.p.id].beforeShowForm)&&d[j.p.id].beforeShowForm.call(j,a("#"+
m));a.jgrid.viewModal("#"+a.jgrid.jqID(q.themodal),{gbox:"#gbox_"+a.jgrid.jqID(k),jqm:b.jqModal,jqM:!1,overlay:b.overlay,modal:b.modal});f()}else{var v=isNaN(b.dataheight)?b.dataheight:b.dataheight+"px",o=a("<form name='FormPost' id='"+o+"' class='FormGrid' style='width:100%;overflow:auto;position:relative;height:"+v+";'></form>"),E=a("<table id='"+l+"' class='EditTable' cellspacing='1' cellpadding='2' border='0' style='table-layout:fixed'><tbody></tbody></table>");p&&(r=p.call(j,a("#"+m)),"undefined"==
typeof r&&(r=!0));if(!1===r)return;a(j.p.colModel).each(function(){var a=this.formoptions;s=Math.max(s,a?a.colpos||0:0);t=Math.max(t,a?a.rowpos||0:0)});a(o).append(E);c(e,j,E,s);l="rtl"==j.p.direction?!0:!1;p="<a href='javascript:void(0)' id='"+(l?"nData":"pData")+"' class='fm-button ui-state-default ui-corner-left'><span class='ui-icon ui-icon-triangle-1-w'></span></a>";r="<a href='javascript:void(0)' id='"+(l?"pData":"nData")+"' class='fm-button ui-state-default ui-corner-right'><span class='ui-icon ui-icon-triangle-1-e'></span></a>";
v="<a href='javascript:void(0)' id='cData' class='fm-button ui-state-default ui-corner-all'>"+b.bClose+"</a>";if(0<t){var y=[];a.each(a(E)[0].rows,function(a,b){y[a]=b});y.sort(function(a,b){return a.rp>b.rp?1:a.rp<b.rp?-1:0});a.each(y,function(b,c){a("tbody",E).append(c)})}b.gbox="#gbox_"+a.jgrid.jqID(k);o=a("<span></span>").append(o).append("<table border='0' class='EditTable' id='"+n+"_2'><tbody><tr id='Act_Buttons'><td class='navButton' width='"+b.labelswidth+"'>"+(l?r+p:p+r)+"</td><td class='EditButton'>"+
v+"</td></tr></tbody></table>");a.jgrid.createModal(q,o,b,"#gview_"+a.jgrid.jqID(j.p.id),a("#gview_"+a.jgrid.jqID(j.p.id))[0]);l&&(a("#pData, #nData","#"+n+"_2").css("float","right"),a(".EditButton","#"+n+"_2").css("text-align","left"));b.viewPagerButtons||a("#pData, #nData","#"+n+"_2").hide();o=null;a("#"+q.themodal).keydown(function(c){if(c.which===27){d[j.p.id].closeOnEscape&&a.jgrid.hideModal(this,{gb:b.gbox,jqm:b.jqModal,onClose:b.onClose});return false}if(b.navkeys[0]===true){if(c.which===b.navkeys[1]){a("#pData",
"#"+n+"_2").trigger("click");return false}if(c.which===b.navkeys[2]){a("#nData","#"+n+"_2").trigger("click");return false}}});b.closeicon=a.extend([!0,"left","ui-icon-close"],b.closeicon);!0===b.closeicon[0]&&a("#cData","#"+n+"_2").addClass("right"==b.closeicon[1]?"fm-button-icon-right":"fm-button-icon-left").append("<span class='ui-icon "+b.closeicon[2]+"'></span>");a.isFunction(b.beforeShowForm)&&b.beforeShowForm.call(j,a("#"+m));a.jgrid.viewModal("#"+a.jgrid.jqID(q.themodal),{gbox:"#gbox_"+a.jgrid.jqID(k),
jqm:b.jqModal,modal:b.modal});a(".fm-button:not(.ui-state-disabled)","#"+n+"_2").hover(function(){a(this).addClass("ui-state-hover")},function(){a(this).removeClass("ui-state-hover")});f();a("#cData","#"+n+"_2").click(function(){a.jgrid.hideModal("#"+a.jgrid.jqID(q.themodal),{gb:"#gbox_"+a.jgrid.jqID(k),jqm:b.jqModal,onClose:b.onClose});return false});a("#nData","#"+n+"_2").click(function(){a("#FormError","#"+n).hide();var c=i();c[0]=parseInt(c[0],10);if(c[0]!=-1&&c[1][c[0]+1]){a.isFunction(b.onclickPgButtons)&&
b.onclickPgButtons.call(j,"next",a("#"+m),c[1][c[0]]);h(c[1][c[0]+1],j);a(j).jqGrid("setSelection",c[1][c[0]+1]);a.isFunction(b.afterclickPgButtons)&&b.afterclickPgButtons.call(j,"next",a("#"+m),c[1][c[0]+1]);g(c[0]+1,c[1].length-1)}f();return false});a("#pData","#"+n+"_2").click(function(){a("#FormError","#"+n).hide();var c=i();if(c[0]!=-1&&c[1][c[0]-1]){a.isFunction(b.onclickPgButtons)&&b.onclickPgButtons.call(j,"prev",a("#"+m),c[1][c[0]]);h(c[1][c[0]-1],j);a(j).jqGrid("setSelection",c[1][c[0]-
1]);a.isFunction(b.afterclickPgButtons)&&b.afterclickPgButtons.call(j,"prev",a("#"+m),c[1][c[0]-1]);g(c[0]-1,c[1].length-1)}f();return false})}o=i();g(o[0],o[1].length-1)}})},delGridRow:function(e,b){b=a.extend({top:0,left:0,width:240,height:"auto",dataheight:"auto",modal:!1,overlay:30,drag:!0,resize:!0,url:"",mtype:"POST",reloadAfterSubmit:!0,beforeShowForm:null,beforeInitData:null,afterShowForm:null,beforeSubmit:null,onclickSubmit:null,afterSubmit:null,jqModal:!0,closeOnEscape:!1,delData:{},delicon:[],
cancelicon:[],onClose:null,ajaxDelOptions:{},processing:!1,serializeDelData:null,useDataProxy:!1},a.jgrid.del,b||{});d[a(this)[0].p.id]=b;return this.each(function(){var f=this;if(f.grid&&e){var c=a.isFunction(d[f.p.id].beforeShowForm),h=a.isFunction(d[f.p.id].afterShowForm),g=a.isFunction(d[f.p.id].beforeInitData)?d[f.p.id].beforeInitData:!1,i=f.p.id,j={},k=!0,m="DelTbl_"+a.jgrid.jqID(i),n,o,l,q,p="DelTbl_"+i,r={themodal:"delmod"+i,modalhead:"delhd"+i,modalcontent:"delcnt"+i,scrollelm:m};jQuery.isArray(e)&&
(e=e.join());if(void 0!==a("#"+a.jgrid.jqID(r.themodal))[0]){g&&(k=g.call(f,a("#"+m)),"undefined"==typeof k&&(k=!0));if(!1===k)return;a("#DelData>td","#"+m).text(e);a("#DelError","#"+m).hide();!0===d[f.p.id].processing&&(d[f.p.id].processing=!1,a("#dData","#"+m).removeClass("ui-state-active"));c&&d[f.p.id].beforeShowForm.call(f,a("#"+m));a.jgrid.viewModal("#"+a.jgrid.jqID(r.themodal),{gbox:"#gbox_"+a.jgrid.jqID(i),jqm:d[f.p.id].jqModal,jqM:!1,overlay:d[f.p.id].overlay,modal:d[f.p.id].modal})}else{var s=
...
else{c[0]=false;c[1]=c[1]+(" "+a.jgrid.errors.nourl)}if(c[0])if(d[f.p.id].useDataProxy){g=f.p.dataProxy.call(f,g,"del_"+f.p.id);typeof g=="undefined"&&(g=[true,""]);if(g[0]===false){c[0]=false;c[1]=g[1]||"Error deleting the selected row!"}else a.jgrid.hideModal("#"+a.jgrid.jqID(r.themodal),{gb:"#gbox_"+a.jgrid.jqID(i),jqm:b.jqModal,onClose:d[f.p.id].onClose})}else a.ajax(g)}if(c[0]===false){a("#DelError>td","#"+m).html(c[1]);a("#DelError","#"+m).show()}return false});a("#eData","#"+m+"_2").click(function(){a.jgrid.hideModal("#"+
a.jgrid.jqID(r.themodal),{gb:"#gbox_"+a.jgrid.jqID(i),jqm:d[f.p.id].jqModal,onClose:d[f.p.id].onClose});return false});c&&d[f.p.id].beforeShowForm.call(f,a("#"+m));a.jgrid.viewModal("#"+a.jgrid.jqID(r.themodal),{gbox:"#gbox_"+a.jgrid.jqID(i),jqm:d[f.p.id].jqModal,overlay:d[f.p.id].overlay,modal:d[f.p.id].modal})}h&&d[f.p.id].afterShowForm.call(f,a("#"+m));!0===d[f.p.id].closeOnEscape&&setTimeout(function(){a(".ui-jqdialog-titlebar-close","#"+a.jgrid.jqID(r.modalhead)).focus()},0)}})},navGrid:function(d,
...
modalhead:"alerthd",modalcontent:"alertcnt"},k=this,m;if(k.grid&&"string"==typeof d){void 0===a("#"+j.themodal)[0]&&(!b.alerttop&&!b.alertleft&&("undefined"!=typeof window.innerWidth?(b.alertleft=window.innerWidth,b.alerttop=window.innerHeight):"undefined"!=typeof document.documentElement&&"undefined"!=typeof document.documentElement.clientWidth&&0!==document.documentElement.clientWidth?(b.alertleft=document.documentElement.clientWidth,b.alerttop=document.documentElement.clientHeight):(b.alertleft=
1024,b.alerttop=768),b.alertleft=b.alertleft/2-parseInt(b.alertwidth,10)/2,b.alerttop=b.alerttop/2-25),a.jgrid.createModal(j,"<div>"+b.alerttext+"</div><span tabindex='0'><span tabindex='-1' id='jqg_alrt'></span></span>",{gbox:"#gbox_"+a.jgrid.jqID(k.p.id),jqModal:!0,drag:!0,resize:!0,caption:b.alertcap,top:b.alerttop,left:b.alertleft,width:b.alertwidth,height:b.alertheight,closeOnEscape:b.closeOnEscape,zIndex:b.alertzIndex},"","",!0));var n=1;b.cloneToTop&&k.p.toppager&&(n=2);for(var o=0;o<n;o++){var l=
a("<table cellspacing='0' cellpadding='0' border='0' class='ui-pg-table navtable' style='float:left;table-layout:auto;'><tbody><tr></tr></tbody></table>"),q,p;0===o?(q=d,p=k.p.id,q==k.p.toppager&&(p+="_top",n=1)):(q=k.p.toppager,p=k.p.id+"_top");"rtl"==k.p.direction&&a(l).attr("dir","rtl").css("float","right");b.add&&(c=c||{},m=a("<td class='ui-pg-button ui-corner-all'></td>"),a(m).append("<div class='ui-pg-div'><span class='ui-icon "+b.addicon+"'></span>"+b.addtext+"</div>"),a("tr",l).append(m),
a(m,l).attr({title:b.addtitle||"",id:c.id||"add_"+p}).click(function(){a(this).hasClass("ui-state-disabled")||(a.isFunction(b.addfunc)?b.addfunc.call(k):a(k).jqGrid("editGridRow","new",c));return false}).hover(function(){a(this).hasClass("ui-state-disabled")||a(this).addClass("ui-state-hover")},function(){a(this).removeClass("ui-state-hover")}),m=null);b.edit&&(m=a("<td class='ui-pg-button ui-corner-all'></td>"),f=f||{},a(m).append("<div class='ui-pg-div'><span class='ui-icon "+b.editicon+"'></span>"+
b.edittext+"</div>"),a("tr",l).append(m),a(m,l).attr({title:b.edittitle||"",id:f.id||"edit_"+p}).click(function(){if(!a(this).hasClass("ui-state-disabled")){var c=k.p.selrow;if(c)a.isFunction(b.editfunc)?b.editfunc.call(k,c):a(k).jqGrid("editGridRow",c,f);else{a.jgrid.viewModal("#"+j.themodal,{gbox:"#gbox_"+a.jgrid.jqID(k.p.id),jqm:true});a("#jqg_alrt").focus()}}return false}).hover(function(){a(this).hasClass("ui-state-disabled")||a(this).addClass("ui-state-hover")},function(){a(this).removeClass("ui-state-hover")}),
...
a(this).addClass("ui-state-hover")},function(){a(this).removeClass("ui-state-hover")}),m=null);b.del&&(m=a("<td class='ui-pg-button ui-corner-all'></td>"),h=h||{},a(m).append("<div class='ui-pg-div'><span class='ui-icon "+b.delicon+"'></span>"+b.deltext+"</div>"),a("tr",l).append(m),a(m,l).attr({title:b.deltitle||"",id:h.id||"del_"+p}).click(function(){if(!a(this).hasClass("ui-state-disabled")){var c;if(k.p.multiselect){c=k.p.selarrrow;c.length===0&&(c=null)}else c=k.p.selrow;if(c)a.isFunction(b.delfunc)?
...
g=g||{},a(m).append("<div class='ui-pg-div'><span class='ui-icon "+b.searchicon+"'></span>"+b.searchtext+"</div>"),a("tr",l).append(m),a(m,l).attr({title:b.searchtitle||"",id:g.id||"search_"+p}).click(function(){a(this).hasClass("ui-state-disabled")||(a.isFunction(b.searchfunc)?b.searchfunc.call(k,g):a(k).jqGrid("searchGrid",g));return false}).hover(function(){a(this).hasClass("ui-state-disabled")||a(this).addClass("ui-state-hover")},function(){a(this).removeClass("ui-state-hover")}),g.showOnLoad&&
!0===g.showOnLoad&&a(m,l).click(),m=null);b.refresh&&(m=a("<td class='ui-pg-button ui-corner-all'></td>"),a(m).append("<div class='ui-pg-div'><span class='ui-icon "+b.refreshicon+"'></span>"+b.refreshtext+"</div>"),a("tr",l).append(m),a(m,l).attr({title:b.refreshtitle||"",id:"refresh_"+p}).click(function(){if(!a(this).hasClass("ui-state-disabled")){a.isFunction(b.beforeRefresh)&&b.beforeRefresh.call(k);k.p.search=false;try{var c=k.p.id;k.p.postData.filters="";a("#fbox_"+a.jgrid.jqID(c)).jqFilter("resetFilter");
...
oneditfunc:null,successfunc:null,url:null,extraparam:{},aftersavefunc:null,errorfunc:null,afterrestorefunc:null,restoreAfterError:!0,mtype:"POST"},a.jgrid.inlineEdit,k);return this.each(function(){var b=this,c,e,f,g=0,h=null,i={},j,m;b.grid&&(j=a(b).jqGrid("getInd",d,!0),!1!==j&&(f=a(j).attr("editable")||"0","0"==f&&!a(j).hasClass("not-editable-row")&&(m=b.p.colModel,a('td[role="gridcell"]',j).each(function(f){c=m[f].name;var j=!0===b.p.treeGrid&&c==b.p.ExpandColumn;if(j)e=a("span:first",this).html();
else try{e=a.unformat.call(b,this,{rowId:d,colModel:m[f]},f)}catch(k){e=m[f].edittype&&"textarea"==m[f].edittype?a(this).text():a(this).html()}if("cb"!=c&&("subgrid"!=c&&"rn"!=c)&&(b.p.autoencode&&(e=a.jgrid.htmlDecode(e)),i[c]=e,!0===m[f].editable)){null===h&&(h=f);j?a("span:first",this).html(""):a(this).html("");var q=a.extend({},m[f].editoptions||{},{id:d+"_"+c,name:c});m[f].edittype||(m[f].edittype="text");if("&nbsp;"==e||"&#160;"==e||1==e.length&&160==e.charCodeAt(0))e="";q=a.jgrid.createEl.call(b,
m[f].edittype,q,e,!0,a.extend({},a.jgrid.ajaxOptions,b.p.ajaxSelectOptions||{}));a(q).addClass("editable");j?a("span:first",this).append(q):a(this).append(q);"select"==m[f].edittype&&("undefined"!==typeof m[f].editoptions&&!0===m[f].editoptions.multiple&&"undefined"===typeof m[f].editoptions.dataUrl&&a.browser.msie)&&a(q).width(a(q).width());g++}}),0<g&&(i.id=d,b.p.savedRow.push(i),a(j).attr("editable","1"),a("td:eq("+h+") input",j).focus(),!0===k.keys&&a(j).bind("keydown",function(c){if(27===c.keyCode){a(b).jqGrid("restoreRow",
...
e&&a.jgrid.info_dialog(a.jgrid.errors.errcap,"function 'custom_value' "+a.jgrid.edit.msg.nodefined,a.jgrid.edit.bClose),"e2"==e?a.jgrid.info_dialog(a.jgrid.errors.errcap,"function 'custom_value' "+a.jgrid.edit.msg.novalue,a.jgrid.edit.bClose):a.jgrid.info_dialog(a.jgrid.errors.errcap,e.message,a.jgrid.edit.bClose)}}r=a.jgrid.checkValues(o[n],b,m);if(!1===r[0])return r[1]=o[n]+" "+r[1],!1;m.p.autoencode&&(o[n]=a.jgrid.htmlEncode(o[n]));"clientArray"!==j.url&&t.editoptions&&!0===t.editoptions.NullIfEmpty&&
""===o[n]&&(q[n]="null")}});if(!1===r[0]){try{var v=a.jgrid.findPos(a("#"+a.jgrid.jqID(d),m.grid.bDiv)[0]);a.jgrid.info_dialog(a.jgrid.errors.errcap,r[1],a.jgrid.edit.bClose,{left:v[0],top:v[1]})}catch(E){alert(r[1])}return k}var y,i=m.p.prmNames;y=i.oper;v=i.id;o&&(o[y]=i.editoper,o[v]=d,"undefined"==typeof m.p.inlineData&&(m.p.inlineData={}),o=a.extend({},o,m.p.inlineData,j.extraparam));if("clientArray"==j.url){o=a.extend({},o,l);m.p.autoencode&&a.each(o,function(b,c){o[b]=a.jgrid.htmlDecode(c)});
v=a(m).jqGrid("setRowData",d,o);a(s).attr("editable","0");for(i=0;i<m.p.savedRow.length;i++)if(m.p.savedRow[i].id==d){p=i;break}0<=p&&m.p.savedRow.splice(p,1);a(m).triggerHandler("jqGridInlineAfterSaveRow",[d,v,o,j]);a.isFunction(j.aftersavefunc)&&j.aftersavefunc.call(m,d,v,j);k=!0;a(s).unbind("keydown")}else a("#lui_"+a.jgrid.jqID(m.p.id)).show(),q=a.extend({},o,q),q[v]=a.jgrid.stripPref(m.p.idPrefix,q[v]),a.ajax(a.extend({url:j.url,data:a.isFunction(m.p.serializeRowData)?m.p.serializeRowData.call(m,
q):q,type:j.mtype,async:!1,complete:function(b,c){a("#lui_"+a.jgrid.jqID(m.p.id)).hide();if(c==="success"){var e=true,f;f=a(m).triggerHandler("jqGridInlineSuccessSaveRow",[b,d,j]);a.isArray(f)||(f=[true,o]);f[0]&&a.isFunction(j.successfunc)&&(f=j.successfunc.call(m,b));if(a.isArray(f)){e=f[0];o=f[1]?f[1]:o}else e=f;if(e===true){m.p.autoencode&&a.each(o,function(b,c){o[b]=a.jgrid.htmlDecode(c)});o=a.extend({},o,l);a(m).jqGrid("setRowData",d,o);a(s).attr("editable","0");for(e=0;e<m.p.savedRow.length;e++)if(m.p.savedRow[e].id==
d){p=e;break}p>=0&&m.p.savedRow.splice(p,1);a(m).triggerHandler("jqGridInlineAfterSaveRow",[d,b,o,j]);a.isFunction(j.aftersavefunc)&&j.aftersavefunc.call(m,d,b);k=true;a(s).unbind("keydown")}else{a(m).triggerHandler("jqGridInlineErrorSaveRow",[d,b,c,null,j]);a.isFunction(j.errorfunc)&&j.errorfunc.call(m,d,b,c,null);j.restoreAfterError===true&&a(m).jqGrid("restoreRow",d,j.afterrestorefunc)}}},error:function(b,c,e){a("#lui_"+a.jgrid.jqID(m.p.id)).hide();a(m).triggerHandler("jqGridInlineErrorSaveRow",
...
b.p.data[e])}else{a(b).jqGrid("expandRow",b.p.data[e]);a(b).jqGrid("expandNode",b.p.data[e])}a(b).jqGrid("setSelection",d);return false}),d++})},setTreeGrid:function(){return this.each(function(){var d=this,e=0,b,f=!1,c,h=[];if(d.p.treeGrid){d.p.treedatatype||a.extend(d.p,{treedatatype:d.p.datatype});d.p.subGrid=!1;d.p.altRows=!1;d.p.pgbuttons=!1;d.p.pginput=!1;d.p.gridview=!0;null===d.p.rowTotal&&(d.p.rowNum=1E4);d.p.multiselect=!1;d.p.rowList=[];d.p.expColInd=0;b="ui-icon-triangle-1-"+("rtl"==d.p.direction?
"w":"e");d.p.treeIcons=a.extend({plus:b,minus:"ui-icon-triangle-1-s",leaf:"ui-icon-radio-off"},d.p.treeIcons||{});"nested"==d.p.treeGridModel?d.p.treeReader=a.extend({level_field:"level",left_field:"lft",right_field:"rgt",leaf_field:"isLeaf",expanded_field:"expanded",loaded:"loaded",icon_field:"icon"},d.p.treeReader):"adjacency"==d.p.treeGridModel&&(d.p.treeReader=a.extend({level_field:"level",parent_id_field:"parent",leaf_field:"isLeaf",expanded_field:"expanded",loaded:"loaded",icon_field:"icon"},
d.p.treeReader));for(c in d.p.colModel)if(d.p.colModel.hasOwnProperty(c)){b=d.p.colModel[c].name;b==d.p.ExpandColumn&&!f&&(f=!0,d.p.expColInd=e);e++;for(var g in d.p.treeReader)d.p.treeReader[g]==b&&h.push(b)}a.each(d.p.treeReader,function(b,c){if(c&&a.inArray(c,h)===-1){if(b==="leaf_field")d.p._treeleafpos=e;e++;d.p.colNames.push(c);d.p.colModel.push({name:c,width:1,hidden:true,sortable:false,resizable:false,hidedlg:true,editable:true,search:false})}})}})},expandRow:function(d){this.each(function(){var e=
this;if(e.grid&&e.p.treeGrid){var b=a(e).jqGrid("getNodeChildren",d),f=e.p.treeReader.expanded_field,c=e.rows;a(b).each(function(){var b=a.jgrid.getAccessor(this,e.p.localReader.id);a(c.namedItem(b)).css("display","");this[f]&&a(e).jqGrid("expandRow",this)})}})},collapseRow:function(d){this.each(function(){var e=this;if(e.grid&&e.p.treeGrid){var b=a(e).jqGrid("getNodeChildren",d),f=e.p.treeReader.expanded_field,c=e.rows;a(b).each(function(){var b=a.jgrid.getAccessor(this,e.p.localReader.id);a(c.namedItem(b)).css("display",
...
m=f.p.treeReader.loaded,n,o,l,q,p;n=0;var r=e,s;if("undefined"===typeof d||null===d){p=f.p.data.length-1;if(0<=p)for(;0<=p;)n=Math.max(n,parseInt(f.p.data[p][f.p.localReader.id],10)),p--;d=n+1}var t=a(f).jqGrid("getInd",e);s=!1;if(void 0===e||null===e||""===e)r=e=null,n="last",q=f.p.tree_root_level,p=f.p.data.length+1;else if(n="after",o=f.p._index[e],l=f.p.data[o],e=l[f.p.localReader.id],q=parseInt(l[g],10)+1,p=a(f).jqGrid("getFullTreeNode",l),p.length?(r=p=p[p.length-1][f.p.localReader.id],p=a(f).jqGrid("getInd",
r)+1):p=a(f).jqGrid("getInd",e)+1,l[h])s=!0,l[c]=!0,a(f.rows[t]).find("span.cell-wrapperleaf").removeClass("cell-wrapperleaf").addClass("cell-wrapper").end().find("div.tree-leaf").removeClass(f.p.treeIcons.leaf+" tree-leaf").addClass(f.p.treeIcons.minus+" tree-minus"),f.p.data[o][h]=!1,l[m]=!0;o=p+1;b[c]=!1;b[m]=!0;b[g]=q;b[h]=!0;"adjacency"===f.p.treeGridModel&&(b[i]=e);if("nested"===f.p.treeGridModel){var v;if(null!==e){h=parseInt(l[k],10);g=a.jgrid.from(f.p.data);g=g.greaterOrEquals(k,h,{stype:"integer"});
...
10)+2);b[j]=h+1;b[k]=h+2}}if(null===e||a(f).jqGrid("isNodeLoaded",l)||s)a(f).jqGrid("addRowData",d,b,n,r),a(f).jqGrid("setTreeNode",p,o);l&&!l[c]&&a(f.rows[t]).find("div.treeclick").click()}}})})(jQuery);
...
d-b)return c[a]}var f=this,c=f.p.groupingView,h="",g="",i,j,k=c.groupCollapse?c.plusicon:c.minusicon,m,n=[],o=c.groupField.length,k=k+(" tree-wrap-"+f.p.direction);a.each(f.p.colModel,function(a,b){for(var d=0;d<o;d++)if(c.groupField[d]===b.name){n[d]=a;break}});var l=0,q=a.makeArray(c.groupSummary);q.reverse();a.each(c.groups,function(p,r){l++;j=f.p.id+"ghead_"+r.idx;i=j+"_"+p;g="<span style='cursor:pointer;' class='ui-icon "+k+"' onclick=\"jQuery('#"+a.jgrid.jqID(f.p.id)+"').jqGrid('groupingToggle','"+
i+"');return false;\"></span>";try{m=f.formatter(i,r.value,n[r.idx],r.value)}catch(s){m=r.value}h+='<tr id="'+i+'" role="row" class= "ui-widget-content jqgroup ui-row-'+f.p.direction+" "+j+'"><td style="padding-left:'+12*r.idx+'px;" colspan="'+e+'">'+g+a.jgrid.template(c.groupText[r.idx],m,r.cnt,r.summary)+"</td></tr>";if(o-1===r.idx){for(var t=c.groups[p+1],v=void 0!==t?c.groups[p+1].startRow:d.length,E=r.startRow;E<v;E++)h+=d[E].join("");var y;if(void 0!==t){for(y=0;y<c.groupField.length&&t.dataIndex!==
c.groupField[y];y++);l=c.groupField.length-y}for(t=0;t<l;t++)if(q[t]){v="";c.groupCollapse&&!c.showSummaryOnHide&&(v=' style="display:none;"');h+="<tr"+v+' jqfootlevel="'+(r.idx-t)+'" role="row" class="ui-widget-content jqfoot ui-row-'+f.p.direction+'">';for(var v=b(p,t,c.groups),x=f.p.colModel,B,A=v.cnt,F=0;F<e;F++){var u="<td "+f.formatCol(F,1,"")+">&#160;</td>",H="{0}";a.each(v.summary,function(){if(this.nm===x[F].name){x[F].summaryTpl&&(H=x[F].summaryTpl);"string"===typeof this.st&&"avg"===this.st.toLowerCase()&&
