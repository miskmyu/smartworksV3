		...
		if(isEmpty($(target).children())){
			...
			$.ajax({
				...
				success : function(data, status, jqXHR) {
					...
					var btnPlus = input.find('.btn_plus');
					var btnMinus = input.find('.btn_minus');
					if(!isEmpty(btnPlus)) btnPlus.removeClass('btn_plus').addClass('btn_minus');
					if(!isEmpty(btnMinus)) btnPlus.removeClass('btn_minus').addClass('btn_plus');
					target.siblings('li.js_drill_down').find('.btn_minus').removeClass('btn_minus').addClass('btn_plus');
					target.parents('li.js_drill_down').siblings('li.js_drill_down').find('.btn_minus').removeClass('btn_minus').addClass('btn_plus');
					smartPop.closeProgress();											
				},
				error : function(xhr, ajaxOptions, thrownError){
					smartPop.closeProgress();											
			...
			target.hide();
			if(!isEmpty(input.find('.btn_minus'))) input.find('.btn_minus').removeClass('btn_minus').addClass('btn_plus');
		}
		return false;
	});
