...
<script type="text/javascript">
	getIntanceList = function(paramsJson, progressSpan, isGray){
		...
		$.ajax({
			...
			success : function(data, status, jqXHR) {
				$('#group_instance_list_page').html(data);
	...
	selectListParam = function(progressSpan, isGray){
		var groupList = $('.js_group_list_page');
		var forms = groupList.find('form:visible');
		var paramsJson = {};
		paramsJson["href"] = "jsp/content/community/group_instance_list.jsp";
		var searchFilters = groupList.find('form[name="frmSearchFilter"]');
		...
		if(isEmpty(progressSpan)) progressSpan = groupList.find('.js_search_filter_page').next('span.js_progress_span:first');
...
<%
	...
	session.setAttribute("lastLocation", "group_list.sw");
	...
	if (params == null){
		...
		if(!SmartUtil.isBlankObject(savedWorkId) && savedWorkId.equals(Work.ID_GROUP_WORK)){
...
<!-- 컨텐츠 레이아웃-->
<div class="section_portlet js_group_list_page js_work_list_page">
			...
			<div class="body_titl space">
				...
				<div class="noti_in_bodytitle" style="margin-top:25px">
					<div class="pr10 fl">
						...
						</span> | <span class="title current"><fmt:message key="common.title.group_communities"/>
						</span> | <span>
			...
			<div class="contents_space">
				...
				<div>
					...
					<div class="list_title_space js_work_list_title mt15">
						<div class="title"><fmt:message key="common.title.group_list" /></div>
						<div class="title_line_btns">
							<div class="icon_btn_start">
								<a href="new_group.sw" class="js_add_new_group icon_btn_tail"><fmt:message key="nav.communities.add_group"/></a>
							</div>
						</div>
					...
					<div class="list_contents">
						<div id='group_instance_list_page' >
 							<jsp:include page="/jsp/content/community/group_instance_list.jsp"/>
						</div>
					</div>
					<!-- 목록 테이블 //-->
				</div>
