...
<script type="text/javascript">
	...
	function submitForms(e) {
		...
		if (SmartWorks.GridLayout.validate(workTransfer.find('form.js_validation_required'), $('.js_pop_error_message'))) {
			...
			var fromMember = workTransfer.find('td[fieldId="txtFromMember"] .js_community_item');
			var givenMember = workTransfer.find('td[fieldId="txtGivenMember"] .js_community_item');
			if(fromMember.attr('comId') === givenMember.attr('comId')){
...
<!-- 컨텐츠 레이아웃-->
<div class="section_portlet setting_section js_work_transfer_page" fromMemberId="">
		...
		<ul class="portlet_r" style="display: block;">
			...
			<form name="frmWorkTransfer" class="js_validation_required">
				<div class="contents_space" style="width:700px">
					<table>
						<tr>
							<th class="required_label"><fmt:message key="transfer.title.from_member" /></th>
							<td class="js_type_userField" fieldId="txtFromMember" multiUsers="false">
