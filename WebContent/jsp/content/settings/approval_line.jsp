...
<script type="text/javascript">
	...
	selectListParam = function(progressSpan, isGray){
		...
		progressSpan = approvalLine.find('span.js_progress_span:first');
...
<!-- 컨텐츠 레이아웃-->
<div class="section_portlet setting_section js_approval_line_page">
	<div class="portlet_t"><div class="portlet_tl"></div></div>
	<div class="portlet_l" style="display: block;">
		<ul class="portlet_r" style="display: block;">
			<!-- 타이틀 -->
			<div class="body_titl">
				<div class="body_titl_area ti_approval title_noico"><fmt:message key="settings.title.approval.setting"/></div>
					...
					<div>
						<table>
							<tbody>
								...
								%>
										<tr class="js_edit_approval_line list_action_item border_bottom" lineId=<%=CommonUtil.toNotNull(approvalLine.getId()) %>>
