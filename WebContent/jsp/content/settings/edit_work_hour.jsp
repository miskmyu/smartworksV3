			...
			smartPop.confirm( confirmMessage, function(){
				...
				$.ajax({
					...
					success : function(data, status, jqXHR) {
						...
						smartPop.showInfo(smartPop.INFO, isEmpty(policyId) ? smartMessage.get('createWorkHourSucceed') : smartMessage.get('setWorkHourSucceed'), function(){
...
<div class="form_wrap up mb2 js_edit_work_hour_page" policyId="<%=CommonUtil.toNotNull(policyId)%>">
