						...
						$.ajax({
							...
							success : function(data, status, jqXHR) {
								...
								if(tempSave){
									...
									refreshCurrentContent(newPicture);
...
<div class="up_wrap js_new_picture_page" workId="<%=SmartWork.ID_FILE_MANAGEMENT%>" currentHref="<%=currentHref%>" currentLocation="<%=currentLocation%>">
