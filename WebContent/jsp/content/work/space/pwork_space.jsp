...
<!-- 컨텐츠 레이아웃-->
<div class="section_portlet js_pwork_space_page" lastHref="<%=lastHref %>" workId="<%=workId%>" instId="<%=instId%>" taskInstId="<%=CommonUtil.toNotNull(taskInstId) %>" workSpaceType="<%=workSpace.getSpaceType()%>">
