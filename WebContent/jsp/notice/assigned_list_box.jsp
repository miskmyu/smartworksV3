...
%>
					...
					<div class="info_ms_section">
						...
						<div class="info_list">
							<a href="smart.sw#<%=workInstance.getController()%>?cid=<%=workInstance.getContextId()%>&workId=<%=workId%>&taskInstId=<%=taskInstance.getId()%>"><%=workInstance.getSubject()%>▶<%=taskInstance.getName()%></a>
