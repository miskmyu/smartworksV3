...
// Popup window code
	...
	window.location.href = 'http://bpm.cnuct.kr:8862/smartworksV3/situationManual.sw?userviceCode='+ userviceCode + '&serviceCode=' + serviceCode + '&eventCode=' + eventCode + '&statusCode=' + statusCode + '&page=manual';
