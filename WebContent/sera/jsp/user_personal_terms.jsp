...
<div class="policy_wrap">
  ...
  <div class="content">
    ...
    <p> ④ 경찰청 사이버테러대응센터 (http://www.ctrc.go.kr/02-392-0330) <br>
    </p>
  </div>
  <div style="width:86px; height:36px; margin:0 auto;"> <a href="javascript:self.close();"> <img width="86" height="36" title="확인" alt="확인" src="../images/btn_policyOk.png"> </a> </div>
</div>
</body>
</html>
