...
%>
<div class="js_mission_calendar_page" prevMonth="<%=prevMonthStr %>" nextMonth="<%=nextMonthStr%>" courseId="<%=courseId%>" startDate="" endDate="">
	<table>
...
$(document).ready(function(){
	...
	$('.js_calendar_space').fullCalendar({
	    ...
	    events: function(start, end, callback) {
	    	...
	    	var courseId = $('.js_mission_calendar_page').attr('courseId');
	        $.ajax({
