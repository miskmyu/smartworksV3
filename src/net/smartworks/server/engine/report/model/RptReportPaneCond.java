...
public class RptReportPaneCond extends MisObjectCond {


	private static final long serialVersionUID = 1L;
	private static Log logger = LogFactory.getLog(RptReportPaneCond.class);
	protected static final String PREFIX = "Rpt";
	
	private static final String NAME = CommonUtil.toName(RptReportPaneCond.class, PREFIX);
