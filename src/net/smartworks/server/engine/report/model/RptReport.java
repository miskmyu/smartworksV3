...
public class RptReport extends MisObject {


	private static final long serialVersionUID = 1L;
	private static Log logger = LogFactory.getLog(RptReport.class);
	protected static final String PREFIX = "Rpt";
	
	private static final String NAME = CommonUtil.toName(RptReport.class, PREFIX);
