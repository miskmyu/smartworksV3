...
//	}
	public TaskInstance getTaskInstance(){
		...
		taskInstance.setId(this.getId());
		taskInstance.setName(this.getName());
		taskInstance.setAssignee((this.getAssignee()!=null) ? this.getAssignee().getUserModel():null);
		taskInstance.setAssigner((this.getAssigner()!=null) ? this.getAssigner().getUserModel():null);
		taskInstance.setCreatedDate(this.getCreatedDate());
		taskInstance.setForwardId(this.getForwardId());
		taskInstance.setLastModifiedDate(this.getLastModifiedDate());
		taskInstance.setLastModifier((this.getLastModifier()!=null) ? this.getLastModifier().getUserModel():null);
		taskInstance.setOwner((this.getOwner()!=null) ? this.getOwner().getUserModel():null);
		taskInstance.setPerformer((this.getPerformer()!=null) ? this.getPerformer().getUserModel():null);
		taskInstance.setStatus(this.getStatus());
		taskInstance.setSubject(this.getSubject());
		taskInstance.setTaskType(this.getTaskType());
		taskInstance.setType(this.getType());
